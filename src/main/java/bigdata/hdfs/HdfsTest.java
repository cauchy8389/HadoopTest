...
public class HdfsTest {
    ...
    //创建新文件
    public static void createFile(Configuration conf,String dst , byte[] contents) throws IOException{
    ...
    public static void main(String[] args) throws IOException {
        ...
        /***
         * 本地操作HDFS的时候，需要让主机用户Administrator有操作权限      hadoop fs -chmod 777 /
         */
        ...
        //测试上传文件
        uploadFile(conf,"E:\\text.txt", "/user/zhy/logs");
